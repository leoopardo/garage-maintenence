    ...
    <div className={`w-full ${className ?? ""} flex flex-col gap-1`}>
      ...
      <div className="relative mt-2 flex rounded-md shadow-sm">
        ...
        <input
          ...
          value={value}
          className={`block w-full rounded-md border-0 border-none py-2.5 text-lg outline-none ${paddingLeft ? `pl-${paddingLeft}` : "pl-7"} ${paddingRight ? `pr-${paddingRight}` : "pr-20"} text-gray-900 ring-1 ring-inset ring-gray-300 transition-all duration-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-500 sm:text-sm sm:leading-6`}
